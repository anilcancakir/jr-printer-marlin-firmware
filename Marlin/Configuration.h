...
#define CONFIG_EXAMPLES_DIR "Anilcan/Junior"
...
#define STRING_CONFIG_H_AUTHOR "(Anilcan Cakir, Junior)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 124.75
  #define DEFAULT_bedKi 21.75
  #define DEFAULT_bedKd 476.90
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 31.5, 19, 31.5, 19 } // (mm) Left, Front, Right, Back insets
